...
#methods to load data taken from https://github.com/kircherlab/CADD/blob/master/scripts/sklearnTools/handling.py
...
#convert sparse scipy array in sparse tensor
...
#define autoencoder with two layers in the encoder and the decoder
...
#define autoencoder with one layer in den encoder and the decoder
